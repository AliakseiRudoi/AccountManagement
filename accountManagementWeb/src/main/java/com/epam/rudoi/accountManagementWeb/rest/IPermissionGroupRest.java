package com.epam.rudoi.accountManagementWeb.rest;
...
public interface IPermissionGroupRest {
	 ...
	 * @throws ServiceException the service exception
	 */
	void linkWithPermissions(PermissionGroup permissionGroup) throws ServiceException;
	 ...
	 * @throws ServiceException the service exception
	 */
	void unlinkWithPermissions(PermissionGroup permissionGroup) throws ServiceException;
