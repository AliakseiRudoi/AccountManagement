...
public class User {
	...
	public User(Long userId, String firstName, String lastName, String userName, String userEmail, List<Role> rolesList,
	...
	public String toString() {
		return "User [userId=" + userId + ", firstName=" + firstName + ", lastName=" + lastName + ", userName="
				+ userName + ", userEmail=" + userEmail + ", rolesList=" + rolesList + ", separatePermissionsList="
				+ separatePermissionsList + "]";
	}
